...
<div class:offScreen class="box" use:isOnScreen on:onscreen={(e)=> {offScreen = false;  stopWatching(e.target);}} class:list class:boxed={style=='boxed'} class:eachBoxed={style =='eachBoxed'} class:bordered={style=='bordered'}>
